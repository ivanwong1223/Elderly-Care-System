            ...
            ?>
                    ...
                    <input type="hidden" name="doc_id" value="<?php echo $doc_id ?>">
                        ...
                        <div class="form">
                            ...
                            <input type="text" value="<?php echo $doctor_contact ?>" placeholder="Enter Contact No." name="doctor_contact">
                        </div>
                        <br>
                        <div class="form">
                    ...
                    if(isset($_POST['submitbtn'])){
                        ...
                        doctor_contact='$ddoc_contact', doctor_speciality='$ddoc_speciality', doctor_languages='$ddoc_languages', doctor_gender='$ddoc_gender', shift_hours='$ddoc_shift_hours', doc_pic='$ddoc_pic'
                        WHERE doc_id='$id' ";

                        $run = mysqli_query($con,$update);
                        if($run === true){
                            echo '<script>alert("Record updated!");window.location.href="manage_doctor.php";</script>'; //need update php file name i think//
