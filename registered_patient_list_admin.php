    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="container">
            <form class="search-bar" method="GET">
                <input type="text"  name="search_keyword" placeholder="Search for patients">
        ...
        <?php
            ...
            $sql = "SELECT * FROM patient WHERE patient_ic LIKE '%".$searchkeyword."%' OR pat_id LIKE '%".$searchkeyword."%' 
            OR email LIKE '%".$searchkeyword."%' OR username LIKE '%".$searchkeyword."%' OR gender LIKE '%".$searchkeyword."%'
            ...
            <table style="width: 90%;">
                ...
                <?php
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<td class="link"><a href="edit_registered_patient_admin.php?pat_id='.$row['pat_id'].'" id="edit">Edit</a></td>';
                        echo '<td class="link"><a href="delete_registered_patient.php?pat_id='.$row['pat_id'].'"onclick="return confirm(\'Delete '.$row['username'].'?\');">Delete</a></td>';
                        echo "</tr>";
                    }
                    mysqli_close($con);
                ?>
