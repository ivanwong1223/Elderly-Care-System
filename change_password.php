        ...
        <div class="content">
            ...
            <form action="" method="post" id="login_form">
                <div>
                    ...
                    <div><input name="old_password" id="old_password" type="password" placeholder="Please enter your current password" 
                ...
                <div>
                    ...
                    <div><input name="new_password" id="new_password" type="password" placeholder="Please enter your new password" 
                    required="required" value="" minlength="6"> 
                ...
                <div>
                    ...
                    <div><input name="confirm_password" id="confirm_password" type="password" placeholder="Please re-enter your new password" 
                    required="required" value="" minlength="6"> 
